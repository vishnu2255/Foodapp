    ...
    <div class="col-md-6">
        ...
        <div class="row">
                <label for="card-element">
                      ...
                      <div id="card-element" style="margin-bottom: 30px"> 
...
<div class="row">
     ...
     <div class="row">
            <button class="btn btn-success" style="margin-bottom: 20px">Submit Payment</button>
     </div>
    </div>
...
<script>
    var stripe = Stripe('pk_test_38bijvWZk6dGkZe9s47jqepM');
